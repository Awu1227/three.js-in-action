...
export default class CroppingGeom {
  constructor() {
  ...
  setGeometry() {
    ...
    const arcShape = new THREE.Shape()
      .moveTo(0.5, 0.1)
      .absarc(0.1, 0.1, 0.4, 0, Math.PI * 2, false);

    const holePath = new THREE.Path()
      .moveTo(0.2, 0.1)
      .absarc(0.1, 0.1, 0.1, 0, Math.PI * 2, true);

    arcShape.holes.push(holePath);
    this.geometry = new THREE.ShapeGeometry(arcShape);
  }
